...
use OrderHub\Application\Command\DeleteProduct\DeleteProductHandler;
...
use OrderHub\Application\Command\RebuildProjection\RebuildProjectionHandler;
...
use OrderHub\Application\Command\RetryDeadLetterQueue\RetryDeadLetterQueueHandler;
...
use OrderHub\Application\Query\ListProjectionNames\ListProjectionNamesHandler;
...
use OrderHub\Application\Query\ReplayOrder\ReplayOrderHandler;
...
final class Container
{
    ...
    public function commandBus(): CommandBus
    {
        ...
        return $this->shared(CommandBus::class, function (): CommandBus {
            ...
            $bus->register(DeleteProductCommand::class, new DeleteProductHandler($this->productRepository()));
            ...
            $bus->register(RetryDeadLetterQueueCommand::class, new RetryDeadLetterQueueHandler($this->jobQueue()));
            $bus->register(RebuildProjectionCommand::class, new RebuildProjectionHandler($this->projectionRebuilder()));
    ...
    public function queryBus(): QueryBus
    {
        ...
        return $this->shared(QueryBus::class, function (): QueryBus {
            ...
            $bus->register(ReplayOrderQuery::class, new ReplayOrderHandler($this->eventStore()));
            $bus->register(ListProjectionNamesQuery::class, new ListProjectionNamesHandler($this->projectionRebuilder()));
